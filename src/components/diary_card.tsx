...
export function DiaryCard({
  ...
  return (
    <div
      ...
      className="flex flex-col w-full gap-2 text-lg font-semibold text-center items-center rounded-lg p-1 h-auto"
    >
        ...
        <div className="diary-card flex-col bg-white shadow-md rounded-lg p-4 m-4">
          <div className="flex  justify-between m-2">
            <div className="text-[#22543D] font-bold text-sm md:text-xl ">
              Mood: <DiaryMoodColor mood={value} />
            </div>
            <div className="text-[#22543D] font-bold text-sm md:text-xl">
              {dayjs(created_at).format("DD-MMMM-YYYY")}
            </div>
          </div>
          <div className="m-2 font-normal text-black text-left text-sm md:text-xl">
            {content}
          </div>
        </div>
      </div>
